...
const Testimonials = () => {
    return (
        <section className='py-[112px] mx-[15px] lg:mx-[90px] bg-[#244D4D] bg-opacity-5'>
            ...
            <div className='mt-[100px] lg:flex lg:gap-10 lg:items-start lg:justify-center '>
                <div className='w-72 h-96 rounded-lg overflow-hidden mx-auto  lg:mx-0'>
                ...
                <div className=' lg:max-w-md '>
                    ...
                    <p className='text-[22px] font-bold mt-2'> Larry Page</p>
