...
const PerkBanner = () => {
  return (
    <section className="px-8 py-36 lg:px-24 flex flex-col  lg:flex-row lg:items-end gap-10 lg:gap-5 text-center md:text-left">
      <div className="lg:w-[30%]">
        ...
        <p className="text-sm leading-5 text-[#64717C]">Lorem ipsum dolor sit amet consectetur.</p>
      </div>
